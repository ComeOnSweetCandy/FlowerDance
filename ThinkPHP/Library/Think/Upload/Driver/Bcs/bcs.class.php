...
class BaiduBCS {
	...
	//ACL_TYPE:
	//公开读权限
	const BCS_SDK_ACL_TYPE_PUBLIC_READ = "User-read";
	//公开写权限（不具备删除权限）
	const BCS_SDK_ACL_TYPE_PUBLIC_WRITE = "User-write";
	//公开读写权限（不具备删除权限）
	const BCS_SDK_ACL_TYPE_PUBLIC_READ_WRITE = "User-read-write";
	//公开所有权限
	const BCS_SDK_ACL_TYPE_PUBLIC_CONTROL = "User-control";
