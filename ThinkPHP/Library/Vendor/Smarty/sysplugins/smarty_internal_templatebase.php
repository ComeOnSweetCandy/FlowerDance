...
abstract class Smarty_Internal_TemplateBase extends Smarty_Internal_Data {
    ...
    {
        // User if allowed methodes callable
        if (!empty($allowed)) {
        ...
        // User if block methodes callable
    ...
    public function registerDefaultPluginHandler($callback)
    {
        if (is_callable($callback)) {
            ...
            throw new SmartyException("Tpl plugin handler '$callback' not callable");
        }
    }
    ...
    public function registerDefaultTemplateHandler($callback)
    {
        if (is_callable($callback)) {
            ...
            throw new SmartyException("Tpl template handler '$callback' not callable");
        }
    }
    ...
    public function registerDefaultConfigHandler($callback)
    {
        if (is_callable($callback)) {
            ...
            throw new SmartyException("Tpl config handler '$callback' not callable");
        }
    }
