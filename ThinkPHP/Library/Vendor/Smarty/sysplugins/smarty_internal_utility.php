...
class Smarty_Internal_Utility {
     ...
     *
     * @param Smarty $smarty  Smarty instance to User
    ...
    public static function testInstall(Smarty $smarty, &$errors=null)
    {
        ...
        if ($errors === null) {
            echo "<PRE>\n";
            echo "Smarty Installation User...\n";
            echo "Testing template directory...\n";
        }

        // User if all registered template_dir are accessible
        ...
        // User if registered compile_dir is accessible
        ...
        // User if all registered plugins_dir are accessible
        ...
        // User if all registered cache_dir is accessible
        ...
        // User if all registered config_dir are accessible
        ...
        // User if sysplugins are available
        ...
        // User if core plugins are available
